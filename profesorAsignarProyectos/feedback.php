...
$mysqli->query("INSERT INTO proy_carac (codigo,bitacora,feedback) values('$cod','','$fnuevo')");
echo "Feedback Ingresado!";
echo "<br>";
echo "(<a href='http://localhost/moodle/local/profesorVerProyectos/index.php'>Volver</a>)";
